...
const copy = {
  ...
  suggestions: ["Explícame el fuera de juego", "Cambiar zona horaria", "¿Cómo juega Argentina?"],
...
const templates = {
  ...
  unknown: { followUps: ["Háblame de Kylian Mbappé", "¿Cómo juega España?", "Explícame una tarjeta roja"], text: "No entendí la pregunta. Prueba con un jugador, una selección, un partido o una regla." },
  ...
  h2hNone: (d) => `${d.first} y ${d.second} nunca se han enfrentado en un partido verificado entre selecciones absolutas.${d.hasFixture ? " Este será su primer duelo." : " Si se enfrentan en el futuro, será su primer duelo."}`,
  h2hRecord: (d) => `${d.hasFixture ? "Antes de este partido, " : ""}${d.first} sumaba ${plural(d.firstWins, "victoria", "victorias")}, hubo ${plural(d.draws, "empate", "empates")} y ${d.second} sumaba ${plural(d.secondWins, "victoria", "victorias")}; ${plural(d.goals, "gol", "goles")} en total.`,
