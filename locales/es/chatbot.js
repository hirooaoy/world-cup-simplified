...
const copy = {
  ...
  suggestions: ["Explícame el fuera de juego", "¿Quién ganó?", "¿Cómo juega Argentina?", "Reportar un problema"],
...
const intents = {
  ...
  replacements: [
    ...
    [/proximo mundial|mundial 2030|copa del mundo 2030/g, " next world cup "],
    ...
    [/cuando|a que hora/g, " when "], [/donde/g, " where "],
