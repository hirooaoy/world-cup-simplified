  ...
  switch (type) {
    ...
    case "final-celebration-review": {
      ...
      if (data.variant === "philosophy") {
        ...
        const philosophies = {
          "1930-uruguay": "La filosofía de Uruguay era la audacia: atacar con verticalidad, crear a través de Scarone y lanzar la delantera en oleadas.",
          "1934-italy": "La filosofía de Italia era la autoridad: imponerse al rival, atacar con rapidez y dejar la inventiva a Meazza y Orsi.",
          "1938-italy": "La filosofía de Italia era la disciplina: defender como un bloque y salir después con Meazza, Piola y Colaussi.",
          "1950-uruguay": "La filosofía de Uruguay era la serenidad: resistir la presión de Brasil, tener paciencia y golpear cuando apareciera el espacio.",
          "1954-germany": "La filosofía de Alemania Federal era la fe: mantener el orden, igualar la intensidad de Hungría y luchar hasta el final.",
          "1958-brazil": "La filosofía de Brasil era la libertad: dar espacio a Pelé y Garrincha para improvisar dentro de un sistema ofensivo equilibrado.",
          "1962-brazil": "La filosofía de Brasil era la resiliencia: adaptarse sin Pelé y ganar con Garrincha, ritmo y un juego de bandas incansable.",
          "1966-england": "La filosofía de Inglaterra era la compacidad: poblar el medio, liberar a Bobby Charlton y llenar el área de llegadores.",
          "1970-brazil": "La filosofía de Brasil era la expresión: compartir el balón, intercambiar posiciones y convertir el talento individual en ataques fluidos.",
          "1974-germany": "La filosofía de Alemania Federal era el control: construir con Beckenbauer, marcar sin descanso y dejar que Müller dominara el área.",
          "1978-argentina": "La filosofía de Argentina era la iniciativa: jugar hacia delante, combinar con rapidez y liberar las llegadas de Kempes desde atrás.",
          "1982-italy": "La filosofía de Italia era la paciencia: defender con calma, contraatacar con velocidad y confiar en que Rossi encontraría su momento.",
          "1986-argentina": "La filosofía de Argentina era la liberación: dar libertad a Maradona y organizar a todos los demás a su alrededor.",
          "1990-germany": "La filosofía de Alemania Federal era la intensidad: presionar más arriba, atacar con ambición y dejar que Matthäus impulsara al equipo.",
          "1994-brazil": "La filosofía de Brasil era el equilibrio: controlar el medio con Dunga y liberar a Romário y Bebeto para decidir los partidos.",
          "1998-france": "La filosofía de Francia era la estructura: partir de una defensa poderosa, dominar el medio y dejar que Zidane conectara las piezas.",
          "2002-brazil": "La filosofía de Brasil era la amplitud: estirar al rival con los carrileros y crear alrededor de los movimientos de Ronaldo en el área.",
          "2006-italy": "La filosofía de Italia era la confianza: apoyarse en una defensa de élite, dar el balón a Pirlo y esperar goles de todo el equipo.",
          "2010-spain": "La filosofía de España era la posesión: circular con paciencia, comprimir el campo y presionar justo después de perder el balón.",
          "2014-germany": "La filosofía de Alemania era el intercambio: rotar posiciones, contrapresionar con fiereza y sostener el ritmo gracias a la profundidad colectiva.",
          "2018-france": "La filosofía de Francia era la transición: defender en bloque compacto y después atacar el espacio con Mbappé y Griezmann.",
          "2022-argentina": "La filosofía de Argentina era la adaptación: liberar a Messi, ganar las batallas del medio y cambiar de sistema según lo exigiera el partido.",
          "2026-spain": "La filosofía de España es la posesión: conservar el balón, estirar el campo y rodear al rival en cuanto lo pierde."
        };
