...
const localeCases = [
  {
    ...
    latestReleaseTitle: "Notas de la versión: Prompts de Ball Boy, fichas y líneas del cuadro más limpios",
  ...
  },
  {
    ...
    latestReleaseTitle: "릴리스 노트: 더 깔끔해진 Ball Boy 질문, 선수 카드, 대진표 연결선",
    adminLabel: "운영자 알림",
